...
**Extended scope (v0.5+)**: Derivation checkpoints for tech-stack subdomains — testing (Phase 0.85), observability (Phase 0.86, reserved), etc. — inherit this directive's HITL contract. They do not replace or expand the 4-checkpoint floor; they compose alongside it under the same rules (pause, present, wait, record).
