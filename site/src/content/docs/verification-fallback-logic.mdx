---
title: Verification Fallback Logic
description: Three-tier fallback strategy that keeps every atomic task verifiable — primary, alternative, language-native — and a manual checklist when nothing else works.
category: Guides
order: 20
