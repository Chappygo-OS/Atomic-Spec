...
## What Changed in v0.5.0? _(unreleased — ships after v0.4.1)_
...
- **Full details**: see the [testing derivation guide](https://github.com/Chappygo-OS/Atomic-Spec/blob/main/docs/testing-derivation.md).
