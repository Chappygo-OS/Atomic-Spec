---
title: Support
description: How to file issues, request a new AI agent, and recover from failed releases — plus Atomic Spec's two-tier agent support policy.
category: Community
order: 30
...
- Check the [Atomic Traceability Model guide](/Atomic-Spec/docs/atomic-traceability-model) for the governance model and Spec-Driven Development foundations
- Review the [README](https://github.com/Chappygo-OS/Atomic-Spec#readme) for getting started instructions and the Atomic Traceability Model overview
