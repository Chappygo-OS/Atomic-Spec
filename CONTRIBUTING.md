...
- Update documentation (`README.md`, `atomic-traceability-model.md`) if your changes affect user-facing features.
...
1. Test changes with the `specify` CLI commands (`/atomicspec.specify`, `/atomicspec.plan`, `/atomicspec.tasks`) in your coding agent of choice
